...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    width: 130,
    valueGetter: (params: GridValueGetterParams) =>
      formatCurrency(params.row.paymentTotal, params.row.currency),
  },
  {
    field: 'creditTotal',
    ...
    width: 130,
    valueGetter: (params: GridValueGetterParams) =>
      formatCurrency(params.row.creditTotal, params.row.currency),
  },
  {
    field: 'bank',
    headerName: 'Bank',
    width: 130,
    valueGetter: (params: GridValueGetterParams) => params.row.bank.name,
  },
  {
    field: 'dueDate',
    headerName: 'Due Date',
  ...
  },
  {
    ...
    width: 130,
    valueGetter: (params: GridValueGetterParams) =>
      formatDate(params.row.paymentDate),
  },
